...
function setChartHeight(iframe) {
    if(iframe == 'fixed') {
        ...
        document.getElementsByClassName('container')[0].style.height = '828px';
        document.getElementsByClassName('main')[0].style.height = '800px';
        ...
        let height = 800; //Altura total del main
